...
int main() {
	...
	// create an env
	const wchar_t* model_path = L"models/yolo11n.onnx"; // we got static and dynamic I/O shapes in a given onnx model
	...
	*/
	...
	cv::Mat FlattenImage;
	hwcToChw(resized, FlattenImage); // ~1.5 ms 
	//convertHWCtoCHW(resized, FlattenImage); //  2.8 ms
